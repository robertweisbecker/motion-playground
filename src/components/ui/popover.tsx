    ...
    <PopoverPrimitive.Portal>
      <PopoverPrimitive.Content
        ...
        className={cn(
          ...
          '[--popover-border:var(--outline)]',
          // 'not-dark:data-top:[--popover-border:oklch(from_var(--outline),l_c_h_/_calc(alpha*2)))',

          // 'dark:[--popover-border:color-mix(in_oklch,var(--popover),white_5%)]',
          // 'dark:[--popover-border:var(--outline)]',
          '[--popover-arrow-start:var(--popover-border)]',
          '[--popover-arrow-middle:var(--popover-border)]',
          '[--popover-arrow-end:var(--popover-border)]',
          '[--popover-arrow-highlight:color-mix(in_oklch,var(--popover-border),white_20%)]',

          'dark:data-right:[--popover-arrow-middle:var(--popover-arrow-highlight)] dark:data-right:[--popover-arrow-start:var(--popover-arrow-highlight)]',
          'dark:data-left:[--popover-arrow-end:var(--popover-arrow-highlight)] dark:data-left:[--popover-arrow-middle:var(--popover-arrow-highlight)]',
          'dark:data-bottom:[--popover-arrow-end:var(--popover-arrow-highlight)] dark:data-bottom:[--popover-arrow-middle:var(--popover-arrow-highlight)]',
          ...
          'max-w-64 min-w-14',
          'data-left:min-h-14 data-right:min-h-14',
          // Spacing
          'p-3',
          // Container
          'rounded-2xl',
          ...
          // 'shadow-[inset_0_1px_0_var(--color-white-alpha-100),inset_0_1px_0_var(--color-black-alpha-25),var(--shadow-sm)] drop-shadow-xs',
          // Dark
          'group/popover',
          // 'outline outline-[var(--popover-border)] dark:-outline-offset-1',
          // Side-specific border radius
          'data-left:rounded-e-[1.25rem] data-right:rounded-s-[1.25rem]',
          'data-top:rounded-b-[1.25rem] data-bottom:rounded-t-[1.25rem]',
          // Animations - enter/exit
          'data-[state=open]:animate-in data-[state=open]:blur-in-[1px] data-[state=open]:zoom-in-98',
          'data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:blur-out-sm data-[state=closed]:zoom-out-98',
          // Animations - slide from side
          'data-bottom:slide-in-from-top-1 data-[state=closed]:data-bottom:slide-out-to-top-10',
          'data-left:slide-in-from-right-2 data-[state=closed]:data-left:slide-out-to-right-4',
          'data-right:slide-in-from-left-2 data-[state=closed]:data-right:slide-out-to-left-3',
          'data-top:slide-in-from-bottom-1 data-[state=closed]:data-top:slide-out-to-bottom-4',
          // 'duration-50',
          'data-[state=closed]:duration-150 data-[state=open]:duration-25',
  ...
  return (
    ...
    >
      ...
      <path
        ...
        className="fill-[url(#myLinearGradient)]"
        // group-data-[side=top]/popover:fill-border-alpha dark:fill-border dark:group-data-[side=bottom]/popover:fill-border-alpha-strong"
        // className="fill-[var(--popover-border)]"
      />
      <defs>
        <linearGradient id="myLinearGradient" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop
            offset="10%"
            stopColor="var(--popover-arrow-start,var(--popover-border))"
          />
          <stop
            offset="50%"
            stopColor="var(--popover-arrow-middle,var(--popover-border))"
          />
          <stop
            offset="100%"
            stopColor="var(--popover-arrow-end,var(--popover-border))"
          />
        </linearGradient>
      </defs>
    </svg>
