...
const alertVariants = cva(
  'relative w-full group/alert grid has-data-[slot=icon]:grid-cols-[calc(var(--spacing)*5)_1fr] grid-cols-[0_1fr] has-data-[slot=icon]:gap-x-1.5 gap-y-0.5 items-start  ring-[1px] shadow-2xs',
  {
    variants: {
      variant: {
        ...
        destructive: [
          ...
          'dark:bg-error-950 dark:text-error-300 dark:[&_svg]:text-error-500 dark:inset-ring-error-800',
        ],
        info: [
          'bg-info-25 text-info-600 [&_svg]:text-info-400 ring-info-500/20',
          'dark:bg-info-950 dark:text-info-300 dark:[&_svg]:text-info-500 dark:ring-info-800',
        ],
        highlight: [
          'bg-highlight-25 text-highlight-600 [&_svg]:text-highlight-400 ring-highlight-500/20',
          'dark:bg-highlight-950 dark:text-highlight-300 dark:[&_svg]:text-highlight-500 dark:ring-highlight-800',
        ],
        brand: [
          'bg-brand-25 text-brand-600 [&_svg]:text-brand-400 ring-brand-500/20',
          'dark:bg-brand-950 dark:text-brand-300 dark:[&_svg]:text-brand-500 dark:ring-brand-800',
        ],
        neutral: [
          'bg-neutral-25 text-neutral-600 [&_svg]:text-neutral-400 ring-neutral-500/20',
          'dark:bg-neutral-900 dark:text-neutral-300 dark:[&_svg]:text-neutral-500 dark:ring-neutral-700',
        ],
        warning: [
          'bg-warning-25 text-warning-600 [&_svg]:text-warning-400 ring-warning-500/20',
          'dark:bg-warning-950 dark:text-warning-300 dark:[&_svg]:text-warning-500 dark:ring-warning-800',
        ],
        success: [
          'bg-success-25 text-success-600  [&_svg]:text-success-500 ring-success-500/20',
          'dark:bg-success-950 dark:text-success-300  dark:[&_svg]:text-success-500 dark:ring-success-800',
      ...
      size: {
        default: ['rounded-md p-2 origin-bottom text-sm'],
    ...
    >
      ...
      {dismissible && (
        <Button
          ...
          iconOnly
          size="sm"
          className="absolute end-3 top-3 text-inherit"
          variant="invisible"
        >
          <XIcon weight="bold" />
        </Button>
