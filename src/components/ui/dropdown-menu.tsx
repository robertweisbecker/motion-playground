		...
		<DropdownMenuPrimitive.Portal>
			<DropdownMenuPrimitive.Content
				...
				className={cn(
					...
					'overflow-x-hidden overflow-y-auto rounded-xl p-2 shadow-lg',
					className,
				)}
				{...props}
			/>
...
function DropdownMenuSubTrigger({
	...
	return (
		<DropdownMenuPrimitive.SubTrigger
			...
			data-inset={inset}
			className={cn(
				'flex cursor-default items-center rounded-sm px-2 py-1.5 text-sm outline-hidden select-none focus:bg-current/10 focus:text-current data-[inset]:pl-8 data-[state=open]:bg-current/10 data-[state=open]:text-current',
				className,
			)}
			{...props}
		>
