...
export const CampsiteButton = forwardRef<HTMLButtonElement & HTMLAnchorElement, ButtonProps>(
	(
		{
			id,
			align = 'center',
		...
		return (
			<Tooltip disableHoverableContent>
				...
				{tooltip && (
					<TooltipContent>
						{tooltip} {tooltipShortcut && <Badge>{tooltipShortcut}</Badge>}
					</TooltipContent>
				)}
			</Tooltip>
		);
...
CampsiteButton.displayName = 'CampsiteButton';

// example
// 	<div className="flex flex-row flex-wrap gap-4 bg-gray-200 p-4">
// 					<CampsiteButton variant="base" tooltip="hello">
// 						Base
// 					</CampsiteButton>
...
// 					<CampsiteButton size="sm" variant="base">
// 						Base
// 					</CampsiteButton>
// 					<CampsiteButton size="sm" variant="primary">
// 						primary
// 					</CampsiteButton>
// 					<CampsiteButton size="sm" variant="flat">
// 						flat
// 					</CampsiteButton>
// 					<CampsiteButton size="sm" variant="destructive">
// 						destructive
// 					</CampsiteButton>
// 					<CampsiteButton size="sm" variant="important">
// 						important
// 					</CampsiteButton>
// 					<CampsiteButton size="sm" variant="brand">
// 						brand
// 					</CampsiteButton>
// 					<CampsiteButton size="sm" variant="onboarding">
// 						onboarding
// 					</CampsiteButton>
// 					<CampsiteButton size="sm" variant="text">
// 						text
// 					</CampsiteButton>
// 					<CampsiteButton size="sm" variant="none">
// 						none
// 					</CampsiteButton>
// 					<CampsiteButton variant="primary" rightSlot={<ChevronDownIcon />}>
// 						New call
// 					</CampsiteButton>
// 				</div>
