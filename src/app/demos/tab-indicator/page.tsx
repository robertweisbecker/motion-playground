      ...
      <ul>
        ...
        <li>
          ...
          <div className="group bg-card -mx-4 my-4 flex gap-4 rounded-md border p-4">
            ...
            <Button className="peer relativ mx-auto after:pointer-events-none after:absolute after:inset-0 after:origin-right after:translate-x-full after:outline after:outline-red-500 after:transition-[scale,translate,transform,background] after:ease-in after:select-none peer-data-[state=on]:after:-translate-x-full active:after:translate-x-0 active:after:opacity-100">
              Trigger
            </Button>
          </div>
        </li>
        <li>
          Here's an example with multiple triggers (with a ToggleGroup subbing in for tabs). Only
          the latter two items have indicators and they've been moved below the tiggers, so you can
