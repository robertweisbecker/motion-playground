...
import { BlurFade } from '@/components/experimental/fade';
import { LaptopIcon, LaptopIconDuotone, MonitorIcon } from '@/app/icons/icons';
...
export default function Demo1() {
  return (
    <div className="prose max-w-4xl">
      ...
      <DemoContainer>
        <CardHover2
          href="https://unsplash.com/photos/orange-and-blue-abstract-painting-KG_BfyEgXhk"
          title="Photo cred"
          description={<>Courtesy of MyMind via Unplash</>}
        />
      </DemoContainer>
      ...
      <DemoContainer>
        <div className="grid grid-cols-2 justify-items-start">
          ...
          >
            <Heading id="my-popover-title" className="mt-0 mb-3 text-base! font-medium text-pretty">
          ...
          <div
            ...
            aria-labelledby="my-popover-title"
            aria-describedby="my-popover-desc"
            className="not-prose bg-card [position-anchor]:--trigger2 absolute inset-y-[unset] right-0 bottom-[anchor(top)] left-[anchor(left)] z-50 mb-1 max-w-3xs transform overflow-hidden rounded-lg border px-3 py-2 opacity-0 shadow-lg transition-[opacity,transform,translate,scale] transition-discrete duration-50 ease-out open:translate-y-0 open:scale-100 open:opacity-100 starting:open:translate-y-1 starting:open:scale-90 starting:open:opacity-0"
          >
